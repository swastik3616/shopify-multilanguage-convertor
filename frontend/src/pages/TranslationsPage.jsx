...
function OutlineItem({ section, isActive, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex w-full items-start gap-3 rounded-2xl px-3 py-2.5 text-left transition ${isActive
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="space-y-6">
              ...
              sections.map((section, index) => {
                ...
                return (
                  <motion.article
                    ...
                    className={`rounded-[32px] border bg-white shadow-sm transition ${selectedSectionId === section.id
              ...
              <section className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    />
                    <p
                      className={`mt-1 text-xs ${pageMeta.title.length > TITLE_LIMIT ? "text-rose-600" : "text-emerald-600"
                        }`}
                    >
                  ...
                  <div>
                    ...
                    />
                    <p
                      className={`mt-1 text-xs ${pageMeta.description.length > DESCRIPTION_LIMIT
                          ? "text-rose-600"
                          : "text-emerald-600"
                        }`}
                    >
        ...
        {message && (
          <p
            className={`rounded-3xl border px-4 py-3 text-sm ${messageType === "success"

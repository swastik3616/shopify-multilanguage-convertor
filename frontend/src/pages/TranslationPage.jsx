  ...
  return (
    <button
      ...
      className={`flex w-full items-start gap-3 rounded-2xl px-3 py-2.5 text-left transition ${
        isActive ? "bg-emerald-50 text-emerald-900 ring-1 ring-emerald-200" : "text-slate-600 hover:bg-slate-100 hover:text-slate-900"
      }`}
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="space-y-6">
        ...
        {/* ── Error / info message ── */}
        {message && (
          <p className={`rounded-3xl border px-4 py-3 text-sm ${
            status === "error"
                ...
                return (
                  <motion.article
                    ...
                    className={`rounded-[32px] border bg-white shadow-sm transition ${
                      selectedSectionId === section.id ? "border-emerald-200 ring-2 ring-emerald-100" : "border-slate-200"
                    }`}

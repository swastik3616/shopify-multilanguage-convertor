...
def seed_database():
    ...
    for lang in LANGUAGES:
        # Default English to 'Source', French to 'Target', Spanish to 'Both' for demonstration 
        # (or just Source for English, others None)
        status = 'None'
        if lang['code'] == 'en':
            status = 'Source'
        elif lang['code'] == 'fr':
        ...
        try:
            execute(
                ...
                (lang['name'], lang['code'], status)
            )
        except Exception as e:
            print(f"Error inserting {lang['name']}: {e}")
